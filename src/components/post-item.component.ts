  ...
  template: `
    <article class="p-6 bg-slate-900 rounded-xl border border-slate-800 hover:border-slate-700 transition-colors">
      <div class="flex items-center gap-3 mb-4">
        <img [ngSrc]="authorImage()" width="40" height="40" alt="Robson Cassiano - Autor do post" class="w-10 h-10 rounded-full border border-slate-700 object-cover aspect-square">
        <div>
      ...
      <div class="flex items-center gap-4 border-t border-slate-800 pt-4 text-slate-500 text-sm">
        <button type="button" aria-label="Curtir publicação" class="flex items-center gap-1 hover:text-blue-400 transition-colors">
        ...
        <button type="button" aria-label="Comentar publicação" class="flex items-center gap-1 hover:text-blue-400 transition-colors">

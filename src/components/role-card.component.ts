...
@Component({
  ...
  template: `
    <div class="h-full p-6 rounded-xl bg-slate-900 border border-slate-800 hover:border-lime-500/50 transition-all duration-300 group hover:-translate-y-1 hover:shadow-xl hover:shadow-lime-500/10 flex flex-col justify-between">
      <div>
      ...
      @if (link()) {
        <div class="pt-2">
          <a [href]="link()" target="_blank" rel="noopener noreferrer"
            ...
            class="inline-flex items-center text-sm font-semibold text-lime-400 hover:text-lime-300 transition-colors">
